...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/installation">
    Install Maizzle and create your first project
  </Card>
  <Card title="Editor setup" icon="code" href="/editor-setup">
    Configure your editor for an enhanced workflow
  </Card>
  <Card title="Compatibility" icon="check-circle" href="/compatibility">
    Learn about email client compatibility
  </Card>
  <Card title="Configuration" icon="gear" href="/configuration/css">
    Customize Maizzle to fit your needs
  </Card>
</CardGroup>
...
The build system in Maizzle is based on what we call [Environments](/concepts/environments).
...
Each config file represents a distinct [build Environment](/concepts/environments) that can be triggered with its own `maizzle build [environment]` command, so you can create as many build scenarios as you need, each with their own settings!