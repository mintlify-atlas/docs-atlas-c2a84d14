...
<Note>Maizzle is tested on Node.js 18, 20, and 22.</Note>
...
<Warning>CLI 2.x only works with Maizzle 5 projects, it's not backwards compatible.</Warning>
...
<Note>If using yarn, note that it might have cached your dependencies.</Note>
...
See the [fetch docs](/development/tags#fetch-options) for the available options.
