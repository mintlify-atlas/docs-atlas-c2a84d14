...
<AccordionGroup>
  ...
  <Accordion title="Gmail clipping">
  ...
  <Accordion title="Preview text">
    ...
    <Note>Note that this can increase the risk of Gmail clipping, as it adds a few extra KB to your email's weight.</Note>
  ...
  <Accordion title="Web-safe fonts">
  ...
  <Accordion title="Image blocking">
  ...
  <Accordion title="Bulletproof buttons">
  ...
  <Accordion title="Bulletproof backgrounds">
