...
<Note>
This is inspired by [@M_J_Robbins](https://twitter.com/M_J_Robbins)' link button - see the original on [goodemailcode.com](https://www.goodemailcode.com/email-code/link-button)
</Note>
...
Another approach to buttons in HTML email is coding them with VML, Microsoft's obsolete and deprecated _Vector Markup Language_.
...
<Warning>
Keep in mind that VML code cannot be nested, so you can't use such a button inside a `<v:rect>`, like when coding background images for Outlook on Windows.
</Warning>
...
<Note>
Outlook doesn't support `border-radius`, it will render square corners.
</Note>
