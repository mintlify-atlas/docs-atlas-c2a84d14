...
<Warning>Note that this will apply to _all_ sources and hrefs, including `<a>` tags, as long as the source's initial value is not an URL.</Warning>
...
<ParamField path="tags" type="String[]|<Record<string, boolean|string>>">
...
<ParamField path="styleTag" type="Boolean" default="true">
...
<ParamField path="inlineCss" type="Boolean" default="true">
