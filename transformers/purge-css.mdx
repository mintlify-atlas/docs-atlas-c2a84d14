...
<ParamField path="backend" type="Array<Record<string, string>>" default="[{heads: '{{', tails: '}}'}, {heads: '{%', tails: '%}'}]">
...
<ParamField path="removeHTMLComments" type="Boolean" default="true">
...
If you have CSS inlining enabled, CSS comments will still be removed, even with `removeCSSComments` disabled.
...
<ParamField path="doNotRemoveHTMLCommentsWhoseOpeningTagContains" type="String[]" default="['[if', '[endif']">
...
<ParamField path="uglify" type="Boolean" default="false">
