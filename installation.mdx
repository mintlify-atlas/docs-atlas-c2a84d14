...
They were originally made for Maizzle 4.x, but the same concepts apply in v5 and only some configuration options are different (see our [upgrade guide](/resources/upgrade-guide)).
...
<Note>Maizzle requires at least Node v18.20.0</Note>
...
<Steps>
  <Step title="Navigate to your project">
    Switch the current directory to `my-project`:
...
<Note>These NPM scripts use the Maizzle CLI, check out the [CLI Tool docs](/cli/overview) for more details.</Note>
