...
In this guide, you'll learn how to use Maizzle's [events](/development/events) to automatically package your templates and their images into a zip archive that can be uploaded to Mailchimp.
