...
description: Configure Tailwind CSS and CSS compilation options for email development in Maizzle
---

Configure how Tailwind CSS and CSS are compiled in your Maizzle project.
...
<ParamField path="inline" type="boolean | object" default="undefined">
  ...
  For details, see the [CSS inlining documentation](/transformers/inline-css).
</ParamField>

<ParamField path="purge" type="boolean | object" default="undefined">
  Configure email-safe unused CSS purging.

  For details, see the [CSS Purge Transformer docs](/transformers/purge-css).
</ParamField>

<ParamField path="media" type="boolean | object" default="undefined">
...
<ParamField path="resolveCalc" type="boolean | object" default="true">
  ...
  <Note>Maizzle uses a 2-decimal precision when resolving `calc()` expressions.</Note>
...
<ParamField path="resolveProps" type="boolean | object" default="true">
...
<ParamField path="safe" type="boolean | object" default="true">
  Rewrites Tailwind CSS class names to email-safe alternatives.

  See the [Safe Class Names Transformer docs](/transformers/safe-class-names).
</ParamField>

<ParamField path="shorthand" type="boolean | object" default="undefined">
  Configure rewriting of CSS properties to their shorthand form. Disabled by default.

  See the [Shorthand Transformer docs](/transformers/shorthand-css).
</ParamField>

<ParamField path="sixHex" type="boolean" default="true">
  Whether to convert 3-digit HEX colors to 6-digit HEX colors. Enabled by default.

  See the [Six HEX Transformer docs](/transformers/six-hex).
</ParamField>

<ParamField path="tailwind" type="object" default="undefined">
...
<Note>Only CSS in `<style>` tags will use `!important`, inlined CSS in `style=""` attributes will not.</Note>
...
You may also [configure the replacement mappings](/transformers/safe-class-names) if you need to.
...
<Info>`tailwindcss-email-variants` is already included in the email preset, no need to install it.</Info>
