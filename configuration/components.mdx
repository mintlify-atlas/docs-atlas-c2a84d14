...
description: Configure component paths, tags, and behavior in Maizzle
---
...
<ParamField path="folders" type="array" default="['components', 'layouts', 'emails']">
...
<ParamField path="fileExtension" type="string | string[]" default="html">
...
<ParamField path="tagPrefix" type="string" default="x-">
...
<ParamField path="tag" type="string | boolean" default="component">
...
<ParamField path="attribute" type="string" default="src">
...
<ParamField path="yield" type="string" default="yield">
...
<ParamField path="slot" type="string" default="slot">
  Name for the [`slot` tag](/development/components#slots).
...
<ParamField path="fill" type="string" default="fill">
  Name for the [`fill` tag](/development/components#slots).
...
<ParamField path="slotSeparator" type="string" default=":">
...
<ParamField path="push" type="string" default="push">
  Name for the [\<push\> tag](/development/components#stacks).
</ParamField>

## stack

<ParamField path="stack" type="string" default="stack">
  Name for the [\<stack\> tag](/development/components#stacks).
</ParamField>

## propsScriptAttribute

<ParamField path="propsScriptAttribute" type="string" default="props">
...
<ParamField path="propsContext" type="string" default="props">
...
<ParamField path="propsAttribute" type="string" default="locals">
...
<ParamField path="propsSlot" type="string" default="props">
...
<ParamField path="parserOptions" type="object" default="{ recognizeSelfClosing: true }">
...
<ParamField path="expressions" type="object" default="{/*custom object*/}">
...
<ParamField path="plugins" type="array | object" default="[]">
...
<ParamField path="attrsParserRules" type="object" default="{}">
...
<ParamField path="utilities" type="object" default="{ merge: _.mergeWith, template: _.template }">
...
<ParamField path="elementAttributes" type="object" default="{}">
  ...
  <Note>This is only useful to control which elements can use what attributes. If you'd like to have all elements use an non-standard attribute, use `safelistAttributes` instead.</Note>
</ParamField>

## safelistAttributes

<ParamField path="safelistAttributes" type="array" default="['data-*']">
...
<ParamField path="blacklistAttributes" type="array" default="[]">
